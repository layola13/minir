...
Thanks for wanting to help. Mimir is open source and we welcome contributions of all sizes — from typo fixes to new features.

## Getting Started

```bash
git clone https://github.com/milla-jovovich/mimir.git
cd mimir
...
```
mimir/          ← core package (see mimir/README.md for module guide)
...
Check the [Issues](https://github.com/milla-jovovich/mimir/issues) tab. Great starting points:
